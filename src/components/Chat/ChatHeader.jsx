...
import { FaUserCircle, FaEllipsisV, FaSearch, FaArrowLeft } from "react-icons/fa";
import { BsThreeDotsVertical } from "react-icons/bs";

const ChatHeader = ({ conversation }) => {
    if (!conversation) return (
        <div className="px-4 py-3 border-b border-gray-800 bg-gray-800 text-white">
            <span>Select a chat to start messaging</span>
        </div>
    );
    
    return (
        <div className="px-4 py-2 border-b border-gray-800 bg-gray-800 text-white flex items-center justify-between">
